...
class CirclePointEffect : public Effect
{
public:
	CirclePointEffect(ID3D11Device* device, const std::wstring& filename);
	~CirclePointEffect();
...
public:
	...
	static CirclePointEffect* CirclePointFX;
};
#pragma endregion
