...
: D3DApp(hInstance), mLandVB(0), mLandIB(0), mWavesVB(0), mWavesIB(0), mBoxVB(0), mBoxIB(0), mTreeSpritesVB(0), mCircleVB(0), mCircleIB(0),
  mGrassMapSRV(0), mWavesMapSRV(0), mBoxMapSRV(0), mAlphaToCoverageOn(true),
  mWaterTexOffset(0.0f, 0.0f), mEyePosW(0.0f, 0.0f, 0.0f), mLandIndexCount(0), mCircleIndexCount(0), mRenderOptions(RenderOptions::TexturesAndFog),
...
bool TreeBillboardApp::Init()
{
	...
	//zhy 疑问
	//函数的最后两个参数并没有传递实参，可函数里却收到了正确的值，是如何做到的
